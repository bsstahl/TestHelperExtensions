...
namespace TestHelperExtensions.Test
{
    ...
    public class ShortExtensions_GetRandom_Should
    {
        ...
        {
            TestHelperExtensions.ShortExtensions._rnd = new Random();
        }
        ...
        {
            short lowerBound = Convert.ToInt16(_random.Next(3, 250) + byte.MaxValue);
            short upperBound = Convert.ToInt16(lowerBound + 1);
        ...
        {
            short upperBound = Convert.ToInt16(_random.Next(3, 250) + byte.MaxValue);
        ...
        {
            var maxAllowed = Convert.ToInt16(_random.Next(byte.MaxValue + 1, byte.MaxValue + 230));

            var result = 100000.GetRandomShortValues(maxAllowed, 0);
        ...
        {
            var minAllowed = Convert.ToInt16(_random.Next(byte.MaxValue + 1, byte.MaxValue + 230));
            var maxAllowed = Convert.ToInt16(minAllowed + 500);

            var result = 100000.GetRandomShortValues(maxAllowed, minAllowed);
        ...
        public void GetResultsAcrossTheEntireRangeOfTheRequest()
        {
            ...
            int upperBound = _random.Next(100);
            int lowerBound = -_random.Next(100);
